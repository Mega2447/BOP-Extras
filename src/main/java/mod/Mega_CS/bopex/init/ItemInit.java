...
import mod.Mega_CS.bopex.objects.items.food.FoodBase;
...
public class ItemInit {
	...
	//Items
	@ObjectHolder("biomesoplenty:fleshchunk")
	public static final Item FLESH_CHUNK = null;
	...
	//Food
	public static final Item COOKED_FLESH = new FoodBase("cooked_flesh", 3, 1.0f, false);
}
